...
\begin{tikzpicture}[remember picture,overlay ,every node/.style={anchor=center}]
  ...
  \node at (page cs:0.93,0.37) {\hyperlink{bla.com}{{\def\svgwidth{0.6cm} \input{linkIcon.pdf_tex}}}};
  ...
  \node at (page cs:0.93,-.55) {\hyperlink{bla.com}{{\def\svgwidth{0.6cm}\input{linkIcon.pdf_tex}}}};
  \node at (page cs:0.93,-0.65) {\hyperlink{bla.com}{{\def\svgwidth{0.6cm}\input{linkIcon.pdf_tex}}}};
