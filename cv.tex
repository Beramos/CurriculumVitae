...
\begin{tikzpicture}[remember picture,overlay,every node/.style={anchor=center}]
  ...
  \node at (page cs:0.93,0.37) {\def\svgwidth{0.6cm} \input{linkIcon.pdf_tex}};
  ...
  \node at (page cs:0.93,-.55) {\def\svgwidth{0.6cm}\input{linkIcon.pdf_tex}};
  \node at (page cs:0.93,-0.65) {\def\svgwidth{0.6cm}\input{linkIcon.pdf_tex}};
  \draw (page cs: -0.4,0.29) rectangle (page cs: 1,0.39); % hyperlink rectangles
  \draw (page cs: -0.4,0.39) rectangle (page cs: 1,0.49); % hyperlink rectangles
  \draw (page cs: -0.4,-0.53) rectangle (page cs: 1,-0.63); % hyperlink rectangles
  \draw (page cs: -0.4,-0.63) rectangle (page cs: 1,-0.73); % hyperlink rectangles
\end{tikzpicture}
